...
<head>
    ...
    <title>Book Town Library | Ajouter Livre</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Ajouter Livre</h4>
...
<option value=""> Seléctionner Catégorie</option>
<?php 
$status=1;
...
<option value=""> Seléctionner Auteur</option>
<?php 
...
<button type="submit" name="add" id="add" class="btn btn-info" style="background-color: rgba(171, 103, 26, 1); color:white">Submit </button>
 </div>
</div>
                            </div>
