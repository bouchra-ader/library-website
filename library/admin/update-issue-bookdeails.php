...
<head>
    ...
    <title>Book Town Library | Détails des Livres Empruntés</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Détails des Livres Empruntés</h4>
...
<div class="col-md-6"> 
<div class="form-group">
<label>Etudiant Contact No :</label>
...
<div class="col-md-6"> 
<div class="form-group">
<label>Date d'Emprunt du Livre :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Date de retour du Livre :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Retourner Livre </button>
