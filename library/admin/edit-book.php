...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Changer Image du livre</a>
</div></div>
...
<div class="col-md-6">
<div class="form-group">
<label>Nombre ISBN<span style="color:red;">*</span></label>
...
<div class="col-md-6">
 <div class="form-group">
 <label>Prix en (MAD)<span style="color:red;">*</span></label>
