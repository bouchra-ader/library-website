...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Book Town Library | Student Signup</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Mon Profile</h4>
...
<button type="submit" name="update" class="btn btn-primary" id="submit" style="background-color: rgba(171, 103, 26, 1); color:white">Update Now </button>
